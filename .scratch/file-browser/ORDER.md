...
موج ۱–۲ تمام است (`BE-01`/`FE-02` + `BE-02`/`FE-03` done). `BE-03` done. بعدی: **`FE-04`** UI افزودن sync.
...
| 3   | `BE-03` Document-from-file + add بالک | `FE-04` UI افزودن sync          | 2         | **BE done** / FE next |
