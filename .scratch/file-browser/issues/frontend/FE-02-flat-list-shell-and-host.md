...
- [ ] PluginBasedView: `uniqueName = FileBrowser`, `urlSegment = file-browser`
- [ ] Chrome rules applied; End Sidebar still available
- [ ] Shell library `@mohaymen/file-browser` hosts grid/tile list; host calls ListFiles via plugin execute
- [ ] Paging + name sort reflected in UI from BE contract
- [ ] Host/shell tests cover registration, chrome, and list wiring — do not start before BE-01 is done
